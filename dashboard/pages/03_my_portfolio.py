        ...
        try:
            ...
            if not _risk_holds:
                ...
                if _rr.error:
                    ...
                    # Portfolio β is already in the Risk Profile row above as a
                    # plain _rm() tile; this hero re-frames it with tone
                    # (defensive / market / aggressive) and pairs it with a
                    # per-holding β bar chart against a reference line at 1.0
                    # so users can see WHICH positions push the book above or
                    # below market beta. Backlog IR2 · UI_UX_BACKLOG.md.
                    try:
                        ...
                        if _pb is not None:
                            ...
                            # Per-holding beta chart with reference line at 1.0.
                            _bh_rows = [
                            ...
                            if _bh_rows:
                                ...
                                _fig_beta = px.bar(
                                    ...
                                    orientation="h",
                                    color_discrete_map={
                                        "defensive": "#3fb27f",   # bull
                                        "market":    "#8899bb",   # neutral
                                        "aggressive": "#e26d5c",  # bear
                                    },
                    ...
                    except Exception as _ir2_e:  # noqa: BLE001
