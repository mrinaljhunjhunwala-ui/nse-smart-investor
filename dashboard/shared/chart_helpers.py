...
from dashboard.shared.tokens import COLORS as _TOKENS, hex_to_rgb as _hex_to_rgb  # noqa: E402

PLOT_COLORS = {k: _TOKENS[k] for k in ("bull", "bear", "amber", "accent", "azure", "dim", "faint")}
